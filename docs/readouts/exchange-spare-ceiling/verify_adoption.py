"""At most eight reserved full-game checks after a successful audited confirmation."""
...
def main():
    ...
    assert verdict['games']+8<=1600
    started=time.monotonic()
    jobs=[('confirmation',i,args.study,args.ab2) for i in range(4)]
    jobs += [(family,i,args.study,args.ab2) for family in ('2','4') for i in range(2)]
    ...
    atomic(args.out,dict(passed=True,games=8,total_evaluation_games=verdict['games']+8,
