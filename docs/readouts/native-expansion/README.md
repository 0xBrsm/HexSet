...
is recorded in the [complete campaign](https://github.com/0xBrsm/HexSet/tree/39b1249/docs/readouts/native-recovery), including PLAN.md, STATUS.md, immutable manifests, and stage archives.
