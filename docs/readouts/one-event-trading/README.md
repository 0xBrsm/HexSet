...
_Recovered from the unmerged `feat/two-publish-points` branch (2026-09-03), whose PR was never opened; its `docs/` changes are pulled in here for the record before the branch is deleted, out of chronological order relative to the sections above._
