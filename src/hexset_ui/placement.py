"""A heuristic opening-placement prior, fitted to 40,803 human games.
...
The three terms are the only ones that survived measurement against the corpus.
Pip count dominates; touching more distinct resources and touching a scarce one
each add a little.  Number diversity, port access, complementarity between the
two settlements, pip balance and denial of a rival's best corner were all
measured and were all null at fixed pips — see `agents/status.md`.
